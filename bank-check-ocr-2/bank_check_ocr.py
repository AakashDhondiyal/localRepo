...
os.chdir("C:/Users/admin/AppData/Local\Programs/Python/Python36-32/Scripts/bank-check-ocr-2/")
...
def extract_digits_and_symbols(image, charCnts, minW=4, minH=15):
...
#image = cv2.imread("example_check.png")
image = cv2.imread("4506-T.png")
(h, w,) = image.shape[:2]
delta = int(h - (h * 0.2))
#delta = int(h * 0.3)
#delta = int(h)
bottom = image[delta:h, 0:w]
#bottom = image[0:delta, 0:w]
...
for (gX, gY, gW, gH) in groupLocs:
    ...
    charCnts = grab_contours(charCnts)
